...
- [x] 3.1 The whole gate passes: `npm run ci:gate` — e81e9eb
- [x] 3.2 The gate's guard passes with the new step pinned: `npx vitest run --project unit ci-gate-source` — e81e9eb
- [x] 3.3 Whole suite green: `npm test` — e81e9eb
